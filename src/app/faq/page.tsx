    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="space-y-4">
          <div className="border border-gray-600 rounded-lg overflow-hidden bg-white/5 border-t border-gray-600/10 backdrop-blur-sm">
            <details className="group">
              <summary className="flex justify-between items-center p-6 cursor-pointer hover:bg-white/5 border-t border-gray-600/5 transition-colors">
                <span className="text-xl font-semibold text-white">What will my child get out of this course?</span>
                <svg className="w-6 h-6 text-gray-300 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
              <div className="p-6 bg-white/5 border-t border-gray-600/5 border-t border-gray-600">
          ...
          <div className="border border-gray-600 rounded-lg overflow-hidden bg-white/5 border-t border-gray-600/10 backdrop-blur-sm">
            <details className="group">
              <summary className="flex justify-between items-center p-6 cursor-pointer hover:bg-white/5 border-t border-gray-600/5 transition-colors">
                <span className="text-xl font-semibold text-white">How much does it cost to enroll in this course?</span>
                <svg className="w-6 h-6 text-gray-300 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
          ...
          <div className="border border-gray-600 rounded-lg overflow-hidden bg-white/5 border-t border-gray-600/10 backdrop-blur-sm">
            <details className="group">
              <summary className="flex justify-between items-center p-6 cursor-pointer hover:bg-white/5 border-t border-gray-600/5 transition-colors">
                <span className="text-xl font-semibold text-white">Can I sign up multiple kids?</span>
                <svg className="w-6 h-6 text-gray-300 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
              <div className="p-6 bg-white/5 border-t border-gray-600">
                <p className="text-gray-300">
          ...
          <div className="border border-gray-600 rounded-lg overflow-hidden bg-white/5 border-t border-gray-600/10 backdrop-blur-sm">
            <details className="group">
              <summary className="flex justify-between items-center p-6 cursor-pointer hover:bg-white/5 border-t border-gray-600/5 transition-colors">
                <span className="text-xl font-semibold text-white">What age groups do you serve?</span>
                <svg className="w-6 h-6 text-gray-300 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
          ...
          <div className="border border-gray-600 rounded-lg overflow-hidden bg-white/5 border-t border-gray-600/10 backdrop-blur-sm">
            <details className="group">
              <summary className="flex justify-between items-center p-6 cursor-pointer hover:bg-white/5 border-t border-gray-600/5 transition-colors">
                <span className="text-xl font-semibold text-white">Do you offer trial classes?</span>
                <svg className="w-6 h-6 text-gray-300 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
          ...
          <div className="border border-gray-600 rounded-lg overflow-hidden bg-white/5 border-t border-gray-600/10 backdrop-blur-sm">
            <details className="group">
              <summary className="flex justify-between items-center p-6 cursor-pointer hover:bg-white/5 border-t border-gray-600/5 transition-colors">
                <span className="text-xl font-semibold text-white">What equipment do students need?</span>
                <svg className="w-6 h-6 text-gray-300 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
          ...
          <div className="border border-gray-600 rounded-lg overflow-hidden bg-white/5 border-t border-gray-600/10 backdrop-blur-sm">
            <details className="group">
              <summary className="flex justify-between items-center p-6 cursor-pointer hover:bg-white/5 border-t border-gray-600/5 transition-colors">
                <span className="text-xl font-semibold text-white">Can parents observe classes?</span>
                <svg className="w-6 h-6 text-gray-300 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
          ...
          <div className="border border-gray-600 rounded-lg overflow-hidden bg-white/5 border-t border-gray-600/10 backdrop-blur-sm">
            <details className="group">
              <summary className="flex justify-between items-center p-6 cursor-pointer hover:bg-white/5 border-t border-gray-600/5 transition-colors">
                <span className="text-xl font-semibold text-white">What is the class schedule?</span>
                <svg className="w-6 h-6 text-gray-300 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
          ...
          <div className="border border-gray-600 rounded-lg overflow-hidden bg-white/5 border-t border-gray-600/10 backdrop-blur-sm">
            <details className="group">
              <summary className="flex justify-between items-center p-6 cursor-pointer hover:bg-white/5 border-t border-gray-600/5 transition-colors">
                <span className="text-xl font-semibold text-white">Is there a maximum class size?</span>
                <svg className="w-6 h-6 text-gray-300 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
          ...
          <div className="border border-gray-600 rounded-lg overflow-hidden bg-white/5 border-t border-gray-600/10 backdrop-blur-sm">
            <details className="group">
              <summary className="flex justify-between items-center p-6 cursor-pointer hover:bg-white/5 border-t border-gray-600/5 transition-colors">
                <span className="text-xl font-semibold text-white">What happens if my child misses a class?</span>
                <svg className="w-6 h-6 text-gray-300 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
          ...
          <div className="border border-gray-600 rounded-lg overflow-hidden bg-white/5 border-t border-gray-600/10 backdrop-blur-sm">
            <details className="group">
              <summary className="flex justify-between items-center p-6 cursor-pointer hover:bg-white/5 border-t border-gray-600/5 transition-colors">
                <span className="text-xl font-semibold text-white">Do you offer summer camps?</span>
                <svg className="w-6 h-6 text-gray-300 group-open:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
